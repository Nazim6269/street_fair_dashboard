    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="relative p-2 rounded-full border border-white/10 bg-gray-100 hover:border-purple-400/40 transition-colors">
                ...
                <Tabs defaultValue="all" className="w-full border" onSelect={(e) => e.preventDefault()}>
                    <div className="border-b bg-[#F6F8FA] px-4 pt-4">
                        ...
                        <TabsList className="w-fit justify-start bg-transparent p-0 h-auto gap-4">
                            <TabsTrigger value="all" className="border-0 data-[state=active]:border-b-2 data-[state=active]:border-[#7C3AED] rounded-none p-0 pb-1 shadow-none px-2  data-[state=active]:shadow-none data-[state=active]:shadow-transparent [&[data-state='active']]:shadow-none data-[state=active]:bg-transparent">All</TabsTrigger>
                            <TabsTrigger value="unread" className="border-0 data-[state=active]:border-b-2 data-[state=active]:border-[#7C3AED] rounded-none p-0 pb-1 shadow-none px-2  data-[state=active]:shadow-none data-[state=active]:shadow-transparent [&[data-state='active']]:shadow-none data-[state=active]:bg-transparent">Unread</TabsTrigger>
                        </TabsList>
                    </div>
